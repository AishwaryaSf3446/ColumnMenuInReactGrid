import{j as t}from"./index-CTAXdLKx.js";import{r as p}from"./index-D5jfS-9e.js";import{C as U,a as H,S as w,P as He,b as Ge,Q as Re,i as Nn,c as Be,d as Ke,e as Ln,G as jn,u as V,f as Wn,g as Un,h as Hn,j as Bn,k as Y,W as Kn,A as ge,l as z,m as Ve,O as Qn,T as Qe,U as $n,n as _n}from"./Aggregate-BI4Z3vQF.js";import"./client-Spw3EFno.js";import{m as Jn,a as Xn,u as I,b as O,c as P,d as N,e as L,f as x,g as D,h as A,i as E,j as T,k as R,l as G,n as F,o as Yn,p as Zn,q as et}from"./data-C-zLhcER.js";import{u as nt}from"./useGridTheme-BdxEGH2u.js";const tt=[40,80,120,200],ze=r=>{var Pe,Ne,Le,je,We,Ue;const{enableRtl:v,enableRipple:u,localDataCount:s,isTextWrapData:g,isDialogInsideGrid:h,isStrictMode:k,isMultipleChildren:B,enableDarkMode:j=!1,builtInThemes:he="material",parentContainerHeight:Tn="87vh",isCustomBinding:Z,serverPageSize:fe,defaultOpenGroupExpandKeys:K,isConditionalRowSelection:Ie,...n}=r;((Le=(Ne=n.columns)==null?void 0:Ne[((Pe=n.columns)==null?void 0:Pe.length)-1])==null?void 0:Le.headerText)==="Command Actions"&&(n.columns[((je=n.columns)==null?void 0:je.length)-1].getCommandItems=()=>[t.jsx(U,{type:H.Edit},"Edit"),t.jsx(U,{type:H.Delete},"Delete"),t.jsx(U,{type:H.Update},"Update"),t.jsx(U,{type:H.Cancel},"Cancel")]);const C=p.useRef(null),Fe=p.useRef(null),[ke,Rn]=p.useState(!0),[Q,Gn]=p.useState(!1);nt(he,n.enableDevMode);const S=p.useMemo(()=>g?Jn(s):Xn(s,n.columns),[s,(We=n.columns)==null?void 0:We.length]),[Fn,kn]=p.useState({result:[],count:0,hasMore:((Ue=r.virtualizationSettings)==null?void 0:Ue.scrollMode)===w.Infinite}),qe=p.useCallback(e=>{if(!e.isComplex)return new He(e.field,e.operator,e.value,e.ignoreCase,e.ignoreAccent,e.matchCase);let o=null;const a=e.predicates||[],c=e.condition||"and";for(let m=0;m<a.length;m++){const d=qe(e.predicates[m]);o===null?o=d:o=c.toLowerCase()==="or"?o.or(d):o.and(d)}return o||new He("","","")},[]),Oe=p.useCallback(e=>{var c,m,d,f,q,b,$,ee,ne,te,oe,ae,re,le,ie,_,se,J,de,X,ue,ce,pe;const o=new Ge(S),a=new Re;if((c=e.where)!=null&&c.length){const l=e.where[0],i=qe(l);a.where(i)}if((m=e.search)!=null&&m.length){const{fields:l,value:i}=e.search[0];a.search(i,l)}if((d=e.sort)!=null&&d.length||(f=e.groups)!=null&&f.length&&e.isInitialLoad)if(e.isInitialLoad&&((q=e.groups)!=null&&q.length)){const l=[];for(let i=e.sort.length-1;i>-1;i--)(l==null?void 0:l.find(y=>y.field===e.sort[i].field))||((b=e.groups)!=null&&b.length&&(($=e.groups)!=null&&$.includes(e.sort[i].field))?l.push({field:e.sort[i].field,direction:e.sort[i].direction}):a.sortBy(e.sort[i].field,e.sort[i].direction));l.length&&l.forEach(i=>{a.sortBy(i.field,i.direction)})}else e.sort.forEach(l=>{a.sortBy(l.field,l.direction)});if((ee=e.aggregates)!=null&&ee.length||(te=(ne=C.current)==null?void 0:ne.aggregates)!=null&&te.length){const l=(oe=e.aggregates)!=null&&oe.length?e.aggregates:(ae=C.current)==null?void 0:ae.aggregates;for(let i=0;i<(l==null?void 0:l.length);i++)if((re=l[i])!=null&&re.columns)for(let M=0;M<((le=l[i])==null?void 0:le.columns.length);M++){const y=l[i].columns[M];if(Array.isArray(y.type))for(let me=0;me<y.type.length;me++)a.aggregate((se=(_=(ie=y.type)==null?void 0:ie[me])==null?void 0:_.toLowerCase)==null?void 0:se.call(_),y.field);else a.aggregate((de=(J=y.type)==null?void 0:J.toLowerCase)==null?void 0:de.call(J),y.field)}else{const M=l[i];a.aggregate((ue=(X=M.type)==null?void 0:X.toLowerCase)==null?void 0:ue.call(X),M.field)}}if(e.groups&&((ce=e.groups)!=null&&ce.length))for(let l=0;l<e.groups.length;l++){const i=e.groups[parseInt(l.toString(),10)];a.group(i)}if(e.take&&e.skip){const l=e.skip/e.take+1,i=e.take;a.page(l,i)}else if(e.skip===0&&e.take)a.page(1,e.take);else if(!Nn(e.skip)&&!e.take&&((pe=r.virtualizationSettings)==null?void 0:pe.scrollMode)===w.Infinite){const l=e.skip/fe+1;a.page(l,fe)}e.requiresCounts&&a.requiresCount(),console.log("onDataRequest => ",e,a),o.executeQuery(a).then(l=>{if(e.requestType==="filterChoiceRequest"){const i={result:Be.distinct(l.result,e.select[0],!0),count:l.count};if(e.distinctCounts){const M=new Re;if(e.distinct){const y=e.distinct[0],me=qe(y);M.where(me)}e.select&&M.select(e.select),console.log("onDataRequest => ",e,a),o.executeQuery(M).then(y=>{i.distinctCount=Be.distinct(y.result,e.select[0],!0).length,e.dataSource(i)})}else e.dataSource(i)}else kn({...l,hasMore:S.length>(e.skip??0)+l.result.length})})},[]),qn=p.useCallback(e=>{setTimeout(()=>{if(console.log("onDataChangeRequest => ",e),Array.isArray(e.data)){e.data.forEach(o=>{const a=S.findIndex(c=>c.id===o.id);a!==-1&&(S[a]={...S[a],...o})}),e.saveDataChanges();return}if(e.action==="Add"&&S.unshift(e.data),e.action==="Edit"){for(let o=0;o<S.length;o++)if(S[o].id===e.data.id){S[o]=e.data;break}}if(e.action==="Delete"){for(let o=0;o<e.data.length;o++)for(let a=0;a<S.length;a++)if(S[a].id===e.data[o].id){S.splice(a,1);break}}e.saveDataChanges()},0)},[]),zn=p.useMemo(()=>{var c,m;if(!Z)return;const e=((c=n==null?void 0:n.aggregates)==null?void 0:c.reduce((d,f)=>{var q;return(q=f.columns)==null||q.forEach(b=>{Array.isArray(b.type)?b.type.forEach($=>{d.push({type:$.toLowerCase(),field:b.field})}):d.push({type:b.type.toLowerCase(),field:b.field})}),d},[]))??[],o=((m=n==null?void 0:n.columns)==null?void 0:m.reduce((d,f)=>(f.groupCaptionAggregateType&&d.push(...Array.isArray(f.groupCaptionAggregateType)?f.groupCaptionAggregateType.map(q=>({type:q.toLowerCase(),field:f.field})):[{type:f.groupCaptionAggregateType.toLowerCase(),field:f.field}]),d),[]))??[],a=e==null?void 0:e.concat(o);return a!=null&&a.length?a:void 0},[Z,n==null?void 0:n.aggregates,n==null?void 0:n.columns,Q]);p.useEffect(()=>{var e,o,a,c,m,d,f,q,b,$,ee,ne,te,oe,ae,re,le,ie,_,se,J,de;Z&&Q&&Oe({skip:((e=n==null?void 0:n.pageSettings)==null?void 0:e.currentPage)*((o=n==null?void 0:n.pageSettings)==null?void 0:o.pageSize)||0,...((a=n.virtualizationSettings)==null?void 0:a.scrollMode)!==w.Infinite||(c=n.pageSettings)!=null&&c.estimatedTotalRecordsCount||((m=n.pageSettings)==null?void 0:m.pageSizeControlledBy)==="client"?{take:fe??((d=n==null?void 0:n.pageSettings)==null?void 0:d.pageSize)??(((f=n.virtualizationSettings)==null?void 0:f.scrollMode)===w.Auto||!((q=n.virtualizationSettings)!=null&&q.scrollMode)?12:50)}:{take:fe},groups:(b=n==null?void 0:n.groupSettings)!=null&&b.enabled?($=n==null?void 0:n.groupSettings)==null?void 0:$.columns:[],where:[],search:[],sort:(ee=n==null?void 0:n.sortSettings)!=null&&ee.enabled&&((te=(ne=n==null?void 0:n.sortSettings)==null?void 0:ne.columns)!=null&&te.length)&&(!((oe=n==null?void 0:n.groupSettings)!=null&&oe.enabled)||!((ae=n==null?void 0:n.groupSettings)!=null&&ae.columns))?(re=n==null?void 0:n.sortSettings)==null?void 0:re.columns:(((le=n==null?void 0:n.sortSettings)==null?void 0:le.columns)??[]).concat((ie=n==null?void 0:n.groupSettings)!=null&&ie.enabled&&((_=n==null?void 0:n.groupSettings)!=null&&_.columns)?(J=(se=n==null?void 0:n.groupSettings)==null?void 0:se.columns)==null?void 0:J.map(X=>{var ue,ce,pe;return{field:X,direction:((pe=(ce=(ue=n==null?void 0:n.sortSettings)==null?void 0:ue.columns)==null?void 0:ce.find(l=>l.field===X))==null?void 0:pe.direction)??"Ascending"}}):[]),aggregates:zn??[],...((de=n.virtualizationSettings)==null?void 0:de.scrollMode)!==w.Infinite?{requiresCounts:!0}:{},isInitialLoad:!0})},[Q]),p.useEffect(()=>{j?document.body.classList.add("dark","sf-dark-mode"):document.body.classList.remove("dark","sf-dark-mode")},[j]);const Vn=p.useCallback(e=>e.id%2===0||e.EmployeeID%2===0||e.RecordId%2===0?{selectable:!1}:!0,[Ie]),In=p.useCallback(e=>{var o;return(o=K.includes)==null?void 0:o.call(K,e==null?void 0:e.groupKey)},[K]),On=p.useCallback(e=>{console.error("Grid Error: ",e)},[n==null?void 0:n.onError]),Pn=p.useCallback(e=>tt[e.rowIndex%4],[n==null?void 0:n.getRowHeight]),Ce=()=>{var e;return t.jsxs(t.Fragment,{children:[t.jsxs("button",{onClick:()=>{var o,a;Q&&window.localStorage.removeItem((a=(o=C==null?void 0:C.current)==null?void 0:o.getDataModule())==null?void 0:a.dataManager.guidId),Gn(!Q)},children:[Q?"Destroy":"Render"," Data Grid"]}),s&&!g&&t.jsxs("button",{onClick:()=>Rn(!ke),children:[ke?"Uniform":"Non Uniform"," Row Height Applied"]}),(e=n==null?void 0:n.groupSettings)!=null&&e.enabled?t.jsxs(t.Fragment,{children:[t.jsx("button",{onClick:()=>{var o,a,c;(c=(o=C.current)==null?void 0:o.groupColumn)==null||c.call(o,(a=n==null?void 0:n.groupSettings)==null?void 0:a.columns,!0)},children:"Reset Grouped Columns to Default"}),t.jsx("button",{onClick:()=>{var o,a,c,m,d;(d=(o=C.current)==null?void 0:o.ungroupColumn)==null||d.call(o,[(m=(c=(a=C.current)==null?void 0:a.groupSettings)==null?void 0:c.columns)==null?void 0:m[0]])},children:"Un Group First Grouped Column"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.expandAll)==null||a.call(o)},children:"Expand All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.collapseAll)==null||a.call(o)},children:"Collapse All"}),t.jsx("button",{onClick:()=>{var o,a;(a=(o=C.current)==null?void 0:o.clearGrouping)==null||a.call(o)},children:"Clear Grouping"})]}):null,t.jsx("br",{}),t.jsx("br",{}),Q&&t.jsx(Ln,{dir:v?"rtl":"ltr",ripple:u,locale:n.locale,children:t.jsx(jn,{ref:C,dataSource:Z?Fn:s?S:[],onDataRequest:Z?Oe:void 0,onDataChangeRequest:Z?qn:void 0,shouldExpandGroup:K!=null&&K.length?In:void 0,onError:On,...n,isRowSelectable:Ie?Vn:void 0,columns:n.children?void 0:n.columns,aggregates:n.children?void 0:n.aggregates,getRowHeight:ke?null:Pn,children:B?n.children.props.children:n.children})}),t.jsx("br",{}),t.jsx("button",{onClick:()=>{console.log(C)},children:"dummy navigation checking button with get GridRef"})]})};return t.jsx("div",{ref:Fe,style:{height:Tn,isolation:"isolate"},className:j?"dark sf-dark-mode":"",children:k?t.jsx(p.StrictMode,{children:h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()}):h?t.jsx(Ke,{open:!0,fullScreen:!0,target:Fe.current,children:Ce()}):Ce()})};try{ze.displayName="LargeDataGridTest",ze.__docgenInfo={description:"",displayName:"LargeDataGridTest",props:{parentContainerHeight:{defaultValue:null,description:"",name:"parentContainerHeight",required:!1,type:{name:"Height<string | number>"}},enableRtl:{defaultValue:null,description:`Enables right-to-left (RTL) direction for the grid.
...
\`\`\``,name:"onContextMenuOpen",required:!1,type:{name:"(event: ContextMenuOpenEvent<unknown>) => void | ContextMenuOpenEvent<unknown> | Promise<ContextMenuOpenEvent<unknown>>"}},onContextMenuClose:{defaultValue:null,description:`Fires when the context menu is closed or hidden on the grid.
...
}`,...(Je=(_e=Se.parameters)==null?void 0:_e.docs)==null?void 0:Je.source}}};var Xe,Ye,Ze;ye.parameters={...ye.parameters,docs:{...(Xe=ye.parameters)==null?void 0:Xe.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Ze=(Ye=ye.parameters)==null?void 0:Ye.docs)==null?void 0:Ze.source}}};var en,nn,tn;we.parameters={...we.parameters,docs:{...(en=we.parameters)==null?void 0:en.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(tn=(nn=we.parameters)==null?void 0:nn.docs)==null?void 0:tn.source}}};var on,an,rn;ve.parameters={...ve.parameters,docs:{...(on=ve.parameters)==null?void 0:on.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(dn=(sn=be.parameters)==null?void 0:sn.docs)==null?void 0:dn.source}}};var un,cn,pn;Me.parameters={...Me.parameters,docs:{...(un=Me.parameters)==null?void 0:un.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(pn=(cn=Me.parameters)==null?void 0:cn.docs)==null?void 0:pn.source}}};var mn,gn,hn;xe.parameters={...xe.parameters,docs:{...(mn=xe.parameters)==null?void 0:mn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(hn=(gn=xe.parameters)==null?void 0:gn.docs)==null?void 0:hn.source}}};var fn,Cn,Sn;De.parameters={...De.parameters,docs:{...(fn=De.parameters)==null?void 0:fn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(Sn=(Cn=De.parameters)==null?void 0:Cn.docs)==null?void 0:Sn.source}}};var yn,wn,vn;Ae.parameters={...Ae.parameters,docs:{...(yn=Ae.parameters)==null?void 0:yn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(vn=(wn=Ae.parameters)==null?void 0:wn.docs)==null?void 0:vn.source}}};var bn,Mn,xn;Ee.parameters={...Ee.parameters,docs:{...(bn=Ee.parameters)==null?void 0:bn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(xn=(Mn=Ee.parameters)==null?void 0:Mn.docs)==null?void 0:xn.source}}};var Dn,An,En;Te.parameters={...Te.parameters,docs:{...(Dn=Te.parameters)==null?void 0:Dn.docs,source:{originalSource:`{
  args: {
    modules: {
      ClipboardModule,
      FilterModule,
...
}`,...(En=(An=Te.parameters)==null?void 0:An.docs)==null?void 0:En.source}}};const pt=["LocalData","OverComeBrowserLimit","UrlAdaptorData","WebApiAdaptorData","RowTemplate","TextWrapSample","GroupingSample","ODataV4Sample","CustomBindingSample","conditionalRowSelection","TestGrid"];export{Ae as CustomBindingSample,xe as GroupingSample,Se as LocalData,De as ODataV4Sample,ye as OverComeBrowserLimit,be as RowTemplate,Te as TestGrid,Me as TextWrapSample,we as UrlAdaptorData,ve as WebApiAdaptorData,pt as __namedExportsOrder,Ee as conditionalRowSelection,ct as default};
